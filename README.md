...
|[우선순위 큐](https://www.acmicpc.net/step/13)|★☆☆☆☆|★☆☆☆☆|-|-|heapq라이브러리 사용법 익히는 문제 밖에 없어요...|
|[동적 계획법 2](https://www.acmicpc.net/step/17)|★★★★★|★★★★★|다차원 DP, 크누스 최적화|파일합치기, 행렬 곱셉 순서, 내리막길(사실 이 파트는 다 중요)|고난도 DP를 풀어봅시다!! 내리막길 문제를 풀어보면 dps재귀 구현이 필요한 이유를 느낄 수 있습니다. 크누스 최적화는 언제 되는지 안되는지를 파일합치기와 행렬곱셈순서 문제를 비교하면서 알아봅시다.|
|[스택 2](https://www.acmicpc.net/step/51)|★★★★★|★★★★★|스택|히스토그램, 오아시스 재결합|히스토 그램은 오작수(오른쪽에서 제일 작은 수), 오아시스 재결합은 오큰수(오른쪽에서 제일 큰 수)를 응용한 문제다. 오큰(작)수에 대한 문제가 나오면 스택을 떠올리자|
